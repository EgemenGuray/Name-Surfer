...
public class NameSurferDataBase implements NameSurferConstants {
    ...
    public NameSurferDataBase(String filename){
        try{
            ...
            while(true){
                ...
                dataFile.put(entry.getName().toLowerCase(), entry);
            }
            rd.close();
    ...
    public NameSurferEntry findEntry(String name){
        ...
        return dataFile.get(name.toLowerCase());
    }
     
    private Map<String, NameSurferEntry> dataFile = new HashMap<String, NameSurferEntry>();
}